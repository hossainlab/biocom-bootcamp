...
const Instructors = memo(() => {
  const instructors = [
    {
      ...
      image: "/images/speakers/jubayer.png",
      social: {
    ...
    },
    {
      ...
      image: "/images/speakers/muhib.png",
      social: {
    ...
    },
    {
      ...
      image: "/images/speakers/musab.png",
      social: {
    ...
    },
    {
      ...
      image: "/images/speakers/pritom.png",
      social: {
        linkedin: "https://www.linkedin.com/in/mshahariar/"
      }
    }
  ...
  return (
    <section id="speakers" className="py-24 bg-gradient-to-br from-gray-900 via-red-950/20 to-gray-900 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-gradient-to-br from-red-900/5 via-transparent to-amber-900/5"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          <div className="inline-block mb-4">
            <span className="text-red-400 font-semibold text-sm tracking-wider uppercase">Meet Our Team</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 bg-gradient-to-r from-red-400 via-amber-400 to-red-400 bg-clip-text text-transparent">
            Speakers
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {instructors.map((instructor, index) => (
            <div
              key={index}
              className="group relative bg-gray-800/40 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-red-900/50 hover:border-red-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-red-900/20 hover:-translate-y-2"
            >
              {/* Card gradient overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-red-900/10 to-amber-900/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

              <div className="relative z-10">
                {/* Avatar section */}
                <div className="text-center mb-6">
                  <div className="relative w-32 h-32 mx-auto mb-6">
                    <div className="absolute inset-0 bg-gradient-to-br from-red-600 to-amber-600 rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-300 blur-lg"></div>
                    <img
                      src={instructor.image}
                      alt={instructor.name}
                      loading="lazy"
                      className="relative w-32 h-32 rounded-full object-cover border-4 border-red-900/50 group-hover:border-red-500 transition-all duration-300 group-hover:scale-105"
                    />
                  </div>
                  <h3 className="text-xl font-bold text-white mb-2 group-hover:text-red-400 transition-colors duration-300">
                    {instructor.name}
                  </h3>
                  <p className="text-amber-400 font-medium text-sm mb-4 group-hover:text-amber-300 transition-colors duration-300">
                    {instructor.title}
                  </p>
                </div>
                ...
                {/* Social links */}
                <div className="flex justify-center space-x-4 pt-4 border-t border-red-900/50">
