const Logo = ({ className = "", isLight = false }) => (
  <div className={`flex items-center gap-2 ${className}`} aria-label="DeepBio Logo">
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={isLight ? "text-white" : "text-red-400"}>
    ...
    <span
      className={`text-2xl font-bold ${isLight ? "text-white" : "bg-gradient-to-r from-red-400 to-amber-400 bg-clip-text text-transparent"}`}
