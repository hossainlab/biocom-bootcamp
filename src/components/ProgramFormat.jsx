      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-red-900/50 hover:bg-red-900/20 hover:shadow-2xl hover:scale-105 hover:border-red-500/50 transition-all duration-300 cursor-pointer group">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-red-400 transition-colors duration-300">Career Bootcamp</h3>
          ...
          <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-red-900/50 hover:bg-red-900/20 hover:shadow-2xl hover:scale-105 hover:border-red-500/50 transition-all duration-300 cursor-pointer group">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-red-400 transition-colors duration-300">Skills Accelerator</h3>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-red-900/50 text-center hover:bg-red-900/20 hover:shadow-2xl hover:scale-105 hover:border-red-500/30 transition-all duration-300 cursor-pointer group">
              ...
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-red-400 transition-colors duration-300">Accelerated Career Plan</h3>
              <p className="text-gray-300 mb-4">
                Customized career acceleration pathway with immediate action items and curated resources
              </p>
            </div>

            <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-amber-900/50 text-center hover:bg-amber-900/20 hover:shadow-2xl hover:scale-105 hover:border-amber-500/30 transition-all duration-300 cursor-pointer group">
              ...
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-amber-400 transition-colors duration-300">Elite Network Access</h3>
              <p className="text-gray-300 mb-4">
                Exclusive connections with industry leaders, expert mentors, and high-achieving peers
              </p>
            </div>

            <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-orange-900/50 text-center hover:bg-orange-900/20 hover:shadow-2xl hover:scale-105 hover:border-orange-500/30 transition-all duration-300 cursor-pointer group">
              <div className="w-16 h-16 bg-gradient-to-r from-orange-600 to-orange-700 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-orange-400 transition-colors duration-300">Bootcamp Certification</h3>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-red-900/50 text-center hover:bg-red-900/20 hover:shadow-2xl hover:scale-105 hover:border-red-500/30 transition-all duration-300 cursor-pointer group">
              ...
              <h3 className="text-xl font-bold text-white mb-3 group-hover:text-red-400 transition-colors duration-300">Premium Toolkit</h3>
              <p className="text-gray-300 mb-4">
